...
<body>
  <div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <h1 class="pagetitle__heading">Warehouse On-Hand Inventory</h1>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item"><a href="case-studies.html">Case Studies</a></li>
                <li class="breadcrumb-item active" aria-current="page">Warehouse On-Hand Inventory</li>
              </ol>
            </nav>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
    ...
    ========================= -->
    <section id="textContentSection" class="text-content-section pb-90">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-4">
            <aside class="sidebar mb-30">
              <div class="widget widget-categories">
                <h5 class="widget__title">Industry Solutions</h5>
                <div class="widget-content">
                  <ul class="list-unstyled">
                    <li><a href="#">Retail & Consumer</a></li>
                    <li><a href="#" class="active">Sciences & Healthcare</a></li>
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="text__block">
              ...
              <p class="text__block-desc">Our airfreight staff attaches great importance to customizing the booking
                ...
                That’s why we strive to find the air freight solution that best suits your needs. We’ll ask you when
                the freight is available, what the required delivery date is, and if there’s potential to save on time
            ...
            <div class="text__block-2">
              <h5 class="text__block-title">The Challenge</h5>
              <p class="text__block-desc">With manufacturing and distribution channels in literally every major
                market around the globe, and competing in an industry that is understandably zealous about supply
                chain management, was seeking a logistics partner capable of performing on a truly global scale. The
                service partner envisioned would not only be required to design and deliver on a model that would
                help contain </p>
            </div><!-- /.text-block -->
            <div class="text__block-2">
              <h5 class="text__block-title">The Solution</h5>
              <p class="text__block-desc">Such a commitment from a company of size and complexity, to globally
                integrate and standardize processes and manage logistics in every geographic theater, spoke volumes of
                the organization’s commitment to aggressively managing business costs.</p>
            </div><!-- /.text-block -->
            <div class="text__block-2">
              <h5 class="text__block-title">The Results</h5>
              <p class="text__block-desc">People are the engine of success. Global Project Leader Export/Import
                stated, people at every level recognize the value of a partnership and the importance of working
            ...
            <div id="accordion" class="mb-50">
              <div class="accordion-item">
                ...
                <div id="collapse1" class="collapse" data-parent="#accordion">
                  <div class="accordion__item-body">
                    <p>Our skilled personnel, utilising the latest communications, tracking and processing software,
                      combined with decades of experience, ensure all freight is are shipped, trans-shipped and
                      delivered as safely.</p>
              ...
              <div class="accordion-item">
                ...
                <div id="collapse3" class="collapse show" data-parent="#accordion">
                  <div class="accordion__item-body">
                    <p>Our skilled personnel, utilising the latest communications, tracking and processing software,
                      combined with decades of experience, ensure all freight is are shipped and
                      delivered.</p>
                  </div><!-- /.accordion-item-body -->
                </div>
              </div><!-- /.accordion-item -->
            ...
            <div class="testimonial testimonial-2 testimonial-4 text-center bg-overlay bg-overlay-theme mb-70">
              ...
              </div><!-- /.testimonial-panel-wrap  -->
            </div><!-- /.testimonial4 -->
            <div class="text__block">
              <h5 class="text__block-title">Key Features</h5>
