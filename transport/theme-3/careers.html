        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading text-center mb-50">
              <span class="heading__subtitle">Current Openings</span>
              <h2 class="heading__title">Join Our Team</h2>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-md="2" data-slide-sm="1"
              ...
              <div class=" job-item">
                ...
                <a href="#" class="btn btn__secondary btn__link btn__underlined">
              ...
              <div class=" job-item">
                <div class="job__meta">
                  <span class="job__type">Part Time</span>
              ...
              <div class=" job-item">
                <div class="job__meta">
                  <span class="job__type">Part Time</span>
                  <span class="job__location">Germany</span>
                </div>
                <h4 class="job__title">Chief Financial Officer</h4>
                <p class="job__desc">A chief executive officer (CEO) is the highest-ranking executive in a company, and
                  their primary responsibilities include making major corporate decisions.</p>
              ...
              <div class=" job-item">
                <div class="job__meta">
                  <span class="job__type">Full Time</span>
                  <span class="job__location">London</span>
                </div>
                <h4 class="job__title">Chief Executive Officer</h4>
                <p class="job__desc">A chief executive officer (CEO) is the highest-ranking executive in a company, and
                  their primary responsibilities include making major corporate decisions.</p>
