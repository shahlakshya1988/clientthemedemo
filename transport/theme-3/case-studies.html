...
<body>
  <div class="wrapper">
    ...
    <!-- =========================== 
      projects Grid 
    ============================= -->
    <section id="projectsGrid" class="projects projects-grid pt-100 pb-90">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <ul class="projects-filter justify-content-center">
              <li><a class="filter active" href="#" data-filter="all">All Works</a></li>
              <li><a class="filter" href="#" data-filter=".filter-distribution">Distribution</a></li>
              <li><a class="filter" href="#" data-filter=".filter-warehousing">Warehousing</a></li>
              <li><a class="filter" href="#" data-filter=".filter-optimization">Optimization</a></li>
              <li><a class="filter" href="#" data-filter=".filter-logistics">Logistics</a></li>
              <li><a class="filter" href="#" data-filter=".filter-analystics">Analystics</a></li>
            </ul><!-- /.projects-filter  -->
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
