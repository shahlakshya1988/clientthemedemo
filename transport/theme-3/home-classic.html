  ...
  <div class="wrapper">
          ...
          <div class="container">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav__item with-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="global-locations.html" class="nav__item-link">Global Locations</a>
                    </li>
                    <!-- /.nav-item -->
                      ...
                      <div class="row mx-0">
                        <div class="col-sm-6 dropdown-menu-col">
                          ...
                          <ul class="nav flex-column">
                            ...
                            <li class="nav__item"><a class="nav__item-link" href="single-service.html">Packaging</a>
                            </li>
                            <!-- /.nav-item -->
                          </ul>
                        </div><!-- /.col-sm-6 -->
                        <div class="col-sm-6 dropdown-menu-col">
                          ...
                          <ul class="nav flex-column">
                            ...
                            <li class="nav__item"><a class="nav__item-link" href="single-industry.html">Oil & Gas</a>
                            </li>
                            <!-- /.nav-item -->
                          </ul>
                        </div><!-- /.col-sm-6 -->
                ...
                <li class="nav__item with-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="blog-single-post.html" class="nav__item-link">blog single post</a>
                    </li>
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="case-studies.html" class="nav__item-link">case studies</a></li>
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="case-studies-single.html" class="nav__item-link">case study
                        Single</a>
                    </li>
                    <!-- /.nav-item -->
                  </ul><!-- /.dropdown-menu -->
            ...
            <div class="navbar-modules d-none d-lg-block">
              <ul class="list-unstyled d-flex align-items-center modules__btns-list">
                ...
                <li>
                  <a href="request-quote.html" class="btn btn__primary btn__hover2 module__btn-request">
    ...
    <section id="slider3" class="slider slider-3">
      <div class="carousel owl-carousel carousel-arrows carousel-dots" data-slide="1" data-slide-md="1"
        data-slide-sm="1" data-autoplay="false" data-nav="true" data-dots="false" data-space="0" data-loop="true"
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8 col-xl-6">
                <div class="slide__content d-flex flex-wrap justify-content-between">
                  <h2 class="slide__title">The Best Global Logistics Solutions.</h2>
                  <p class="slide__desc">Competitive advantages to some of the largest companies allover the world.
                  </p>
                  <a href="#" class="btn btn__primary btn__hover3">Our Services</a>
                </div><!-- /.slide-content -->
              </div><!-- /.col-xl-6 -->
            </div><!-- /.row -->
          </div><!-- /.container -->
        ...
        <div class="slide-item align-v-h bg-overlay">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8 col-xl-6">
                <div class="slide__content d-flex flex-wrap justify-content-between">
                  <h2 class="slide__title">Innovative <br> Transportation! </h2>
                  <p class="slide__desc">Competitive advantages to some of the largest companies allover the world.</p>
                  <a href="#" class="btn btn__primary btn__hover3">More About Us</a>
                </div><!-- /.slide-content -->
              </div><!-- /.col-xl-6 -->
            </div><!-- /.row -->
          </div><!-- /.container -->
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="heading heading-3 mb-20 pt-60">
              ...
              <p>Providing the best transport and shipping services available allover the world. Our skilled
                personnel,
    ...
    <!-- ========================
        Services
    =========================== -->
    <section id="services" class="services pb-80  text-center bg-gray">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading text-center mb-50">
              ...
              <p class="heading__desc">Customized logistics solutions will help you analyze, develop and implement
                successful supply chain management strategies from end-to-end.</p>
            </div><!-- /.heading -->
          </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="blog-item">
              ...
              <div class="blog__content">
                ...
                <h4 class="blog__title"><a href="#">Importers achieve cost savings through the First Sale rule!</a>
                </h4>
