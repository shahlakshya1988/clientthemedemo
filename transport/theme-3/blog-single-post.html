...
<body>
  <div class="wrapper">
    ...
    <!-- ======================
      Blog Single
    ========================= -->
    <section id="blogSingle" class="blog blog-single pt-110 pb-50">
      <div class="container">
        <div class="row">
                ...
                <div class="widget__content">
                  ...
                  <div class="widget-post-item">
                    ...
                    <div class="widget__post-content">
                      ...
                      <h6 class="widget__post-title"><a href="#">Importers achieve savings through the First Sale
                          rule!</a></h6>
                  ...
                  <div class="widget-post-item">
                    ...
                    <div class="widget__post-content">
                      ...
                      <h6 class="widget__post-title"><a href="#">Cargo flow through better supply chain
                          control.</a></h6>
                    </div><!-- /.widget-post-content -->
                  </div><!-- /.widget-post-item -->
                </div><!-- /.widget-content -->
