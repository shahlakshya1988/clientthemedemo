...
///////////////////////////
$errors = array();
if(isset($_GET['message']) and isset($_GET['name'])) {
	if(!empty($_GET['name']))
		$sender_name  = stripslashes(strip_tags(trim($_GET['name'])));
	
	if(!empty($_GET['message']))
		$message      = stripslashes(strip_tags(trim($_GET['message'])));
	
	if(!empty($_GET['email']))
		$sender_email = stripslashes(strip_tags(trim($_GET['email'])));
	
	if(!empty($_GET['subject']))
		$subject      = stripslashes(strip_tags(trim($_GET['subject'])));
